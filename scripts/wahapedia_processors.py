...
class Wahapedia40kProcessor:
    ...
    def _load_manifest(self) -> dict[str, str]:
        if self._manifest_path.exists():
            try:
                with open(file=self._manifest_path, mode="r") as f:
    ...
    def save_manifest(self) -> None:
        ...
        with open(file=self._manifest_path, mode="w") as f:
            json.dump(obj=self.manifest, fp=f, indent=4)
    ...
    def _save_json(
        self, json_entries: list[dict[Hashable, str]], filename: str
    ) -> None:
